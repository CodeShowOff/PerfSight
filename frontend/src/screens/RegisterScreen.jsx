...
const RegisterScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950 text-stone-900 dark:text-stone-100 font-sans flex items-center justify-center p-4 transition-colors duration-300 relative py-12">
      ...
      <div className="w-full max-w-md my-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-serif text-stone-900 dark:text-stone-100 mb-2">Create Account</h1>
          <p className="text-sm text-stone-500 dark:text-stone-400">Join the performance collective</p>
        </div>
        ...
        <div className="bg-white dark:bg-stone-900 rounded-xl border border-stone-200 dark:border-stone-800 p-8 shadow-sm transition-colors duration-300">
          <form onSubmit={submitHandler} className="space-y-5">
            {/* Name Field */}
            <div>
              <label htmlFor="name" className="block text-sm font-semibold text-stone-900 dark:text-stone-100 mb-2">
                Full Name
              </label>
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-semibold text-stone-900 dark:text-stone-100 mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          <div className="mt-8 text-center border-t border-stone-100 dark:border-stone-800 pt-6">
            <p className="text-sm text-stone-600 dark:text-stone-400">
              ...
              <Link to="/login" className="font-semibold text-stone-900 dark:text-stone-100 border-b border-stone-900 dark:border-stone-100 hover:text-stone-600 dark:hover:text-stone-300 hover:border-stone-600 dark:hover:border-stone-300 pb-0.5 transition-colors">
                Sign in
              </Link>
            </p>
          </div>
